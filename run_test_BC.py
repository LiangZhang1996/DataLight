...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,               default='benchmark_0103_2_t')
    parser.add_argument("-old_memo",   type=str,               default='benchmark_0103_2')
    parser.add_argument("-model",       type=str,               default="AttentionLightBC") 
    parser.add_argument("-old_dir",    type=str,  default='anon_3_4_jinan_real.json_01_03_23_20_10')
    parser.add_argument("-old_round",  type=str,                default="round_115")
...
class Testor:
    ...
    def run(self):
        ...
        while not done and step_num < int(self.dic_traffic_env_conf["RUN_COUNTS"]/self.dic_traffic_env_conf["MIN_ACTION_TIME"]):
            ...
            next_state, _ = self.env.step(action_list)
