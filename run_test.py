...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,               default='benchmark_0102_25_t')
    parser.add_argument("-old_memo",   type=str,               default='benchmark_0102_25')
    parser.add_argument("-model",       type=str,               default="DataLight") 
    parser.add_argument("-old_dir",    type=str,  default='anon_3_4_jinan_real3.json_01_03_10_17_08')
