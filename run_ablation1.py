"""
Ablation study: without of sequential encoding
Ablation study: use all other features 
"""
...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,           default='benchmark_0101_3')
    parser.add_argument("-mod",        type=str,           default="DataLight2")
